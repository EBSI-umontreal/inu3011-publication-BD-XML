<?php
	...
	Description :
		...
		Pour ce faire, il va lire le fichier "xquery/pleinTexte.xquery" et remplacer les chaînes NOMBASEDONNEE et RECHERCHETEXTE par les bonnes valeurs (NOMBASEDONNEE = concaténation de "db/" + $nomBaseDeDonnées de configuration.php).
	...
	- éditer le fichier "xquery/pleinTexte.xquery"
	*/
	...
	if ($rechercheTexte == ""){
		...
		die("Veuillez spécifier un terme ou une expression à rechercher");
	}
	
	//lecture du fichier "xquery/pleinTexte.xquery" et remplacer les chaînes NOMBASEDONNEE et RECHERCHETEXTE par les bonnes valeurs
